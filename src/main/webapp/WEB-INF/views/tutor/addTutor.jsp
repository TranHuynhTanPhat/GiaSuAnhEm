						...
						<div class="panel-body" style="padding: 5px 10px">
							<form action="" method="post" name="info_frm"
								...
								<div class="form-group">
									...
									<div class="col-11" style="color: #F00">* Vui lòng cung
										cấp đầy đủ thông tin bên dưới để chúng tôi tiện liên lạc.</div>
								</div>
								<div class="form-group">
									<label class="col-4 control-label">Tỉnh/Thành dạy: <span
										style="color: #FF0000">*</span></label>
									<div class="col-7">
										<select name="tinhthanhday" class="form-control"
											id="tinhthanhday"
											onchange="window.open(this.value, '_top', '')">
											<option value="/dang-ky-lam-gia-su.html">Chọn
												Tỉnh/Thành</option>
											...
											<option value="/dang-ky-lam-gia-su-tai-an-giang-3.html">An
												Giang</option>
											<option
												value="/dang-ky-lam-gia-su-tai-ba-ria-vung-tau-4.html">Bà
												Rịa - Vũng Tàu</option>
											...
											<option value="/dang-ky-lam-gia-su-tai-thanh-hoa-58.html">Thanh
												Hóa</option>
											<option
												value="/dang-ky-lam-gia-su-tai-thua-thien-hue-59.html">Thừa
												Thiên Huế</option>
											...
											<tbody>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" id="monday" value="M1M">Toán</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M2M">Lý</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M3M">Hóa</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M4M">Văn</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M5M">Tiếng Anh</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M6M">Sinh</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M7M">Báo bài</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M8M">Sử</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M9M">Tiếng Việt</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M10M">Địa</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M11M">Vẽ</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M12M">Đàn nhạc</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M13M">Tin học</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M14M">Rèn chữ đẹp</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M15M">Tiếng Hoa</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M16M">Tiếng Nhật</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M17M">Anh văn giao tiếp</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M18M">Tiếng Hàn</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M19M">Kế toán</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M20M">Tiếng Nga</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M21M">Tiếng Pháp</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M22M">Tiếng Đức</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M23M">Tiếng Campuchia</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M24M">Tiếng Thái</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="monday[]" value="M25M">Tiếng Ý</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M26M">Môn khác</label></td>
													<td><label><input type="checkbox"
															name="monday[]" value="M27M">Luyện thi đại học</label></td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<div class="col-7">
										<table border="0" class="tablebox">
											<tbody>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" id="lopday" value="L0L">Lớp lá</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L1L">Lớp 1</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L2L">Lớp 2</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" value="L3L">Lớp 3</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L4L">Lớp 4</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L5L">Lớp 5</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" value="L6L">Lớp 6</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L7L">Lớp 7</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L8L">Lớp 8</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" value="L9L">Lớp 9</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L10L">Lớp 10</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L11L">Lớp 11</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" value="L12L">Lớp 12</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L13L">Ôn Đại Học</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L14L">Năng khiếu</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" value="L15L">Ngoại ngữ</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L16L">Lớp khác</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L17L">Hệ Đại học</label></td>
												</tr>
												<tr>
													<td><label><input type="checkbox"
															name="lopday[]" value="L18L">Tin học</label></td>
													<td><label><input type="checkbox"
															name="lopday[]" value="L19L">Mầm non</label></td>
													<td></td>
												</tr>
											</tbody>
										</table>
								...
								<div class="form-group">
									<div class="col-11" style="color: red">
										* Lưu ý: Khi bạn đăng ký làm gia sư, thông tin, hình ảnh của
										bạn phải rõ ràng chính xác và được lưu trữ tại trung tâm nhằm
										phục vụ cho việc quản lý và tạo thuận lợi cho bạn khi đăng ký
										nhận lớp dạy.<br> BẠN PHẢI NHẬP MÃ CÁ NHÂN GỞI VỀ SỐ ĐIỆN
										THOẠI CỦA BẠN THÌ HỒ SƠ ĐĂNG KÝ LÀM GIA SƯ MỚI THÀNH CÔNG
