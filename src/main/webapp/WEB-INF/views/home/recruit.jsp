		...
		<div class="content-temp" style="width: 100%;">
			...
			<p>
				<span style="font-size: x-small;"> </span><span
					style="font-size: medium;"><span style="font-size: x-small;">THÔNG
						BÁO TUYỂN DỤNG GẤP </span><br></span>
			</p>
			<p>
			...
			<p>
				<span style="color: #ff0000;"><strong>THỜI GIAN LÀM
						VIỆC: CHỌN 1 TRONG 3 CA, CÓ THẾ XOAY CA<br>
				</strong></span>
			</p>
			<p>
				<span style="color: #ff0000;"><strong>CA SÁNG: 8H30
						ĐẾN 11H30</strong></span>
			</p>
			<p>
				<span style="color: #ff0000;"><strong>CA CHIỀU: 14H
						ĐẾN 17H30</strong></span>
			</p>
			<p>
				<span style="color: #ff0000;"><strong>CA TỐI : 18H
						ĐẾN 21H</strong></span>
			</p>
			<p>
			...
			<p>
				...
				NHÀ, CÁC LỚP 1 -- 12 LTDH, CÁC LỚP ĐÀN, VẼ, TIN HỌC NGOẠI NGỮ.....<br>LUÔN
				...
				11H30<br>CA CHIỀU : 14H ĐẾN 17H30<br>CA TỐI : 18H ĐẾN 21H<br>LƯƠNG
				THỎA THUẬN . MỌI CHI TIẾT XIN LIÊN HỆ : 109 TÂN LẬP 2&nbsp; F HIỆP
				PHÚ Q9<br>ĐT: 028.35.39.18.19<br>DĐ : 0972.38.38.48
			</p>
