...
<div id="wrapper">
	...
	<div id="page-main">
		...
		<div class="content-temp" style="width: 100%;">
			...
			<p>
				<strong> PHÍ NHẬN LỚP CỦA GIÁO VIÊN LÀ 40% ( Các lớp từ lớp
					lá đến lớp 12)</strong>
			</p>
			<p>
				<strong> PHÍ NHẬN LỚP CỦA SINH VIÊN LÀ 40% ( Các lớp từ lớp
					lá đến lớp 12)</strong>
			</p>
			<p>
				<strong> CÁC LỚP TIN HỌC, ĐÀN,VẼ, ANH VĂN GIAO TIẾP, PHÍ LÀ
					30%</strong>
			</p>
			<ul>
			...
			<p>
				<span style="font-size: medium;">Giáo viên và sinh viên sau
					khi thấy lớp phù hợp ở mục lớp dạy cần gia sư thì vui lòng liên hệ:</span>
			</p>
			<ul>
			...
			<ul>
				<li><span style="font-size: medium;">Khi tới trung tâm
						...
						style="color: #3366ff;"> thẻ sinh viên + CMND.</span>Đối với giáo
						viên: <span style="color: #3366ff;">bằng tốt nghiệp + thẻ
							giáo viên + CMND</span>
				</span></li>
			</ul>
			<p>
			...
			<p>
				<span style="color: #ff0000; font-size: small;"><em>TK 3
						: BÙI CÔNG ĐIỆP&nbsp; ngân hàng sacombank chi nhánh tp hcm :
						060128731477</em></span>
			</p>
			<p>
				<span style="color: #ff0000; font-size: small;"><em>TK 4
						: BÙI CÔNG ĐIỆP ngân hàng MB BANK chi nhánh tp hcm&nbsp; :
