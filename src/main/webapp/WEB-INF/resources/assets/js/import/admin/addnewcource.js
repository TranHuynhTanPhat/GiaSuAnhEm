...
var lable_category = document.querySelector('.control-label.category')
...
console.log(list_lophoc)

console.log(lable_lophoc)
...
form.addEventListener('submit', function(e) {
	...
	let isCheckBoxCategoryError = checkCheckBoxError(lable_category, list_category, 'chưa chọn phân loại')
